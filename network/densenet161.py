...
def network(img_rows, img_cols,
            color_type=1, nb_dense_block=4, growth_rate=48,
            nb_filter=96, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=None, isscratch=False):
    '''
    ...
    if isscratch:
        ...
        model.load_weights('imagenet_models/densenet161_weights_tf.h5', by_name=True)
...
if __name__ == '__main__':
    ...
    #     ##Todo:write_csv
    #     y = model.predict()
    #     DR.write_csv(target_file, results, header=['FILE_ID', 'CATEGORY_ID0', 'CATEGORY_ID1', 'CATEGORY_ID2'])
